    ...
    return (
        <div className='h-screen max-h-[1080px] bg-sky-50 font-fredoka overflow-hidden'>
            <motion.div
                ...
                className="max-w-4xl mx-auto py-4 px-4 h-full flex items-center"
            >
                <div className="bg-white rounded-3xl p-4 md:p-6 shadow-2xl border-4 border-purple-300 w-full max-h-[calc(100vh-120px)] overflow-y-auto">
                    {/* Header */}
                    <div className="text-center mb-4 md:mb-6">
                        <motion.div
                            ...
                            className={`inline-flex items-center justify-center w-16 h-16 ${currentOp.color} rounded-full mb-4 shadow-lg`}
                        >
                            <i className={`${currentOp.icon} text-3xl text-white`}></i>
                        </motion.div>
                    ...
                    <div className="mb-4 md:mb-6">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 text-lg font-bold text-center bg-blue-50 border-4 border-blue-300 rounded-2xl focus:outline-none focus:border-blue-500 transition-colors duration-300"
                            maxLength={20}
                        />
                    </div>
                    ...
                    {(operation === 'addition' || operation === 'subtraction') ? (
                        <div className="mb-4 md:mb-5">
                            <h3 className="text-base font-bold text-purple-600 mb-3">Number of Digits</h3>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                {[1, 2, 3, 4].map(digits => (
                                    <motion.button
                                        ...
                                        className={`p-3 rounded-xl border-4 transition-all duration-300 ${
                                            gameSettings.digitCount === digits 
                                                ? 'bg-green-500 text-white border-green-500 shadow-lg' 
                                                : 'bg-green-100 text-green-700 border-green-300 hover:bg-green-200'
                                        }`}
                                    >
                                        <div className="text-xl font-bold mb-1">{digits}</div>
                        ...
                        <div className="mb-4 md:mb-5">
                            <h3 className="text-base font-bold text-purple-600 mb-3">Select Numbers (1-20)</h3>
                            ...
                            <div className="grid grid-cols-10 gap-1 md:gap-2">
                                {Array.from({ length: 20 }, (_, i) => i + 1).map(num => (
                                    <motion.button
                                        ...
                                        className={`aspect-square rounded-md text-sm md:text-base font-bold transition-colors duration-200 flex items-center justify-center ${
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 md:mb-6">
                        <div>
                            <h3 className="text-base font-bold text-purple-600 mb-2">Time per Question</h3>
                            <div className="bg-orange-100 rounded-xl p-3 border-4 border-orange-300 flex flex-col items-center gap-2 shadow-md">
                                <span className="text-2xl font-bold text-orange-600">{gameSettings.timePerQuestion}s</span>
                                <input
                                    type="range"
                                    min="5"
                                    max="60"
