...
const OperationCard = ({ operation, onClick }) => {
  return (
    <motion.button
      ...
      className={`${operation.color.bg} text-white rounded-3xl p-6 sm:p-8 shadow-lg w-full flex flex-col items-center text-center transition-colors duration-300`}
    >
      <i className={`${operation.icon} text-4xl sm:text-6xl mb-4`}></i>
